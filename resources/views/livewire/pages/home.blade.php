...
<div style="min-height: 100vh; background-color: #ffffff;">
    <div style="max-width: 80rem; margin-left: auto; margin-right: auto; padding-left: 1rem; padding-right: 1rem; padding-top: 3rem; padding-bottom: 3rem;">
        <div style="text-align: center; margin-bottom: 3rem;">
            <h1 style="font-size: 2.25rem; font-weight: 700; color: #1f2937; margin-bottom: 1rem;">{{ __('home.title') }}</h1>
            <p style="font-size: 1.25rem; color: #4b5563;">{{ __('home.subtitle') }}</p>
        </div>
            ...
            @forelse($categories as $category)
                <div style="background-color: white; border-radius: 0.5rem; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1); border: 1px solid #e5e7eb; padding: 1.5rem;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem;">
                        <h2 style="font-size: 1.125rem; font-weight: 600; color: #1f2937;">{{ $category->getNameAttribute() }}</h2>
